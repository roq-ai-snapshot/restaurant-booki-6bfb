  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Restaurant Booking Engine v2 - Streamlining your dining experience by simplifying table reservations and menu management."
        />
      </Head>
      <HomeLayout>
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Restaurant Booking Engine v2 - Streamlining your dining experience by simplifying table reservations and menu management.`}
            </Text>
            <Box
